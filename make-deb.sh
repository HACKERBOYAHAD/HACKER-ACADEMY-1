...
# Make Deb Package for HACKER ACADEMY (^.^)
_PACKAGE=HACKER ACADEMY
_VERSION=2.3.5
_ARCH="all"
...
Version: ${_VERSION}
Architecture: ${_ARCH}
Maintainer: @HACKERBOYAHADFB
Depends: ${_depend}
Homepage: https://github.com/HACKERBOYAHADFB/HACKER ACADEMY
...
cp -fr .github/ .sites/ LICENSE README.md HACKER ACADEMY.sh ./build_env/$_opt_dir
